...
model = Sequential()
model.add(Embedding(30000, 8, input_length=maxlen))
...
model.save('pre_trained_1D_model.h5')
...
model = tf.keras.models.load_model('pre_trained_1D_model.h5')
...
model.save('pre_trained_simpleRNN_model.h5')
...
# model = tf.keras.models.load_model('pre_trained_simpleRNN_model.h5')
# model.evaluate(x_test, y_test)
